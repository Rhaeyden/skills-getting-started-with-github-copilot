...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps, build endurance, and train for interschool meets",
    ...
    "Drama Society": {
        "description": "Practice acting, stage design, and prepare for school performances",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific topics with peers",
